...
import 'package:Taqyem/components/pwa_install_dialog.dart';
  ...
  void initState() {
    ...
    if (kIsWeb) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        PwaInstallService.checkAndShowPwaDialog(context);
      });
    }
  }
            ...
            return FutureBuilder<DocumentSnapshot>(
              ...
              builder: (context, userDocSnapshot) {
                ...
                if (userDocSnapshot.hasData && userDocSnapshot.data != null) {
                  ...
                  // Log de débogage
                  print(
                      'Erreur lors de la récupération du document utilisateur ou document introuvable.');
