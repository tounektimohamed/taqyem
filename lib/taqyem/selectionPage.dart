  ...
  Future<void> _saveOCRConfiguration(List<String> levels) async {
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'levels': levels,
        'mappedToSystem':
            'character', // Car vous utilisez le système de caractères
      ...
      body: _isLoading
          ...
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                // Récupérer et trier les barèmes par ordre alphabétique
                ...
                baremesDocs.sort((a, b) {
                  ...
                  // Supprimer les diacritiques pour un tri plus précis
                  String cleanNameA =
                      removeArabicDiacritics(nameA.toLowerCase());
                  String cleanNameB =
                      removeArabicDiacritics(nameB.toLowerCase());
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Container(
                      ...
                      child: Card(
                        ...
                        child: ExpansionTile(
                          initiallyExpanded: _isExpanded[baremeId] ??
                              false, // Garder l'état ouvert/fermé
                          onExpansionChanged: (isExpanded) {
                            setState(() {
                              _isExpanded[baremeId] = isExpanded;
                            });
                          },
                          leading: Container(
                            width: 40,
                          ...
                          children: [
                            FutureBuilder<QuerySnapshot>(
                              ...
                              builder: (context, sousSnapshot) {
                                ...
                                var sousBaremesDocs =
                                    List.from(sousSnapshot.data!.docs);

                                sousBaremesDocs.sort((a, b) {
                                  String nameA = _isFrenchInterface
                                      ? DataTranslator.translateSousBareme(
                                          a['name'])
                                      : a['name'];
                                  String nameB = _isFrenchInterface
                                      ? DataTranslator.translateSousBareme(
                                  ...
                                  String cleanNameA = removeArabicDiacritics(
                                      nameA.toLowerCase());
                                  String cleanNameB = removeArabicDiacritics(
                                      nameB.toLowerCase());
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount: sousBaremesDocs.length,
                                  itemBuilder: (context, sousIndex) {
                                    var sousBareme = sousBaremesDocs[sousIndex];
    ...
    try {
      ...
      for (var baremeEntry in _selectedSousBaremes.entries) {
        for (var sousEntry in baremeEntry.value.entries) {
          if (sousEntry.value) {
            ...
            baremesToKeep[baremeEntry.key] =
                false; // false car ce n'est pas le barème qui est sélectionné
          }
        }
      }
      ...
      for (var existingDoc in existingSelections.docs) {
        ...
        if (!baremesToKeep.containsKey(baremeId)) {
          ...
          var sousBaremesSnapshot =
              await existingDoc.reference.collection('sousBaremes').get();
      ...
      for (var baremeId in baremesToKeep.keys) {
        try {
          ...
          bool hasSelectedSousBaremes =
              sousBaremesToKeep.containsKey(baremeId) &&
          ...
          await selectionsRef.doc(baremeId).set({
            ...
            'classId': widget.selectedClass,
            'matiereId': widget.selectedMatiere,
            'selected': baremesToKeep[baremeId] ??
                false, // true si barème sélectionné, false si seulement sous-barèmes
          ...
          if (sousBaremesToKeep.containsKey(baremeId)) {
            for (var sousBaremeId in sousBaremesToKeep[baremeId]!) {
              try {
                ...
                print(
                    'Erreur lors de la sauvegarde du sous-barème $sousBaremeId: $e');
              }
            }
          }
...
class _SelectionPageState extends State<SelectionPage> {
  ...
  Future<void> fetchMatieres(String classId) async {
    try {
      ...
      allMatieres.sort((a, b) =>
          removeArabicDiacritics(a['name']!.toLowerCase())
